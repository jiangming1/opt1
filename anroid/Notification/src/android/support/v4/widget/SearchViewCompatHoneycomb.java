...
class SearchViewCompatHoneycomb
{
  ...
  {
    SearchView localSearchView = (SearchView)paramObject1;
    SearchView.OnCloseListener localOnCloseListener = (SearchView.OnCloseListener)paramObject2;
    paramObject1.setOnCloseListener(paramObject2);
  }

  public static void setOnQueryTextListener(Object paramObject1, Object paramObject2)
  {
    SearchView localSearchView = (SearchView)paramObject1;
    SearchView.OnQueryTextListener localOnQueryTextListener = (SearchView.OnQueryTextListener)paramObject2;
    paramObject1.setOnQueryTextListener(paramObject2);
  }
  ...
  public static void setSearchableInfo(View paramView, ComponentName paramComponentName)
  {
    ...
    SearchableInfo localSearchableInfo = ((SearchManager)localSearchView.getContext().getSystemService("search")).getSearchableInfo(paramComponentName);
    localSearchView.setSearchableInfo(localSearchableInfo);
  }
  ...
  abstract interface OnCloseListenerCompatBridge
  {
