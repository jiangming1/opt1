...
Global $oIE = _IEcreate("http://bbs.xdowns.com/pub/")
$b=""
...
$oIE.document.parentWindow.myform.txtcontent.value=$b
$oIE.document.parentWindow.myform.email.value="2100803@qq.com"
$oIE.document.parentWindow.myform.qq.value="2100803"
$oIE.document.parentWindow.myform.writer.value="免费软件"
$oIE.document.parentWindow.myform.txttitle.value=IniRead(@ScriptDir &"\百度提交软件.ini", "Genera"&$i, "softName", "AutoIt")
;Local $obutton = _IEGetObjByName($oIE, "myform")
$oIE.document.myform.submit()
