...
$a_Image = myReadImageToArray(@ScriptDir&"\code\3029.bmp", False, 1, 0xbbbbbb);学习3029, 还缺145678没学过
myArrarOCR($s_FontFile, $a_Image, 0, $CodeNum, $CodeWidth, "3029", $func_left, $func_mid, $func_top, $func_bottom)

$a_Image = myReadImageToArray(@ScriptDir&"\code\5489.bmp", False, 1, 0xbbbbbb);学习5489, 还缺167没学过
myArrarOCR($s_FontFile, $a_Image, 0, $CodeNum, $CodeWidth, "5489", $func_left, $func_mid, $func_top, $func_bottom)

$a_Image = myReadImageToArray(@ScriptDir&"\code\4467.bmp", False, 1, 0xbbbbbb);学习4467,还缺1没学过
myArrarOCR($s_FontFile, $a_Image, 0, $CodeNum, $CodeWidth, "4467", $func_left, $func_mid, $func_top, $func_bottom)

$a_Image = myReadImageToArray(@ScriptDir&"\code\2123.bmp", False, 1, 0xbbbbbb);学习2128,0-9都学完了
myArrarOCR($s_FontFile, $a_Image, 0, $CodeNum, $CodeWidth, "2123", $func_left, $func_mid, $func_top, $func_bottom)
