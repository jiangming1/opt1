...
$a_Image = myReadImageToArray(@ScriptDir&"\code\2454.bmp", True, 1, 0xbbbbbb);用true,false都可以,这里是举例
...
$a_Image = myReadImageToArray(@ScriptDir&"\code\4467.bmp", True, 1, 0xbbbbbb);
$s_code_string = myArrarOCR(@ScriptDir&"\CodeFont.txt", $a_Image, 1, $CodeNum, $CodeWidth, "", $func_left, $func_mid, $func_top, $func_bottom)
MsgBox(0, "识别结果", $s_code_string);
