...
$a_Image = myReadImageToArray(@ScriptDir&"\code\2.bmp", True, 1, 0x777777);71704
...
MsgBox(0, "识别结果", $s_code_string);71704

$a_Image = myReadImageToArray(@ScriptDir&"\code\11.bmp", True, 1, 0x777777);52838
$a_Image = myArrayDelBox($a_Image, 1, 1, 1, 1);去边框
$s_code_string = myArrarOCR(@ScriptDir&"\CodeFont.txt", $a_Image, 1, $CodeNum, $CodeWidth, "", $func_left, $func_mid, $func_top, $func_bottom)
MsgBox(0, "识别结果", $s_code_string);52838
