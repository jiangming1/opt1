...
$a_Image = myReadImageToArray(@ScriptDir&"\code\11.jpg", True, 1, 0x777777)
myArrarOCR(@ScriptDir&"\CodeFont.txt", $a_Image, 0, 4, 8, "6281", 6, 5, 4, 4)
$a_Image = myReadImageToArray(@ScriptDir&"\code\16.jpg", True, 1, 0x777777)
myArrarOCR(@ScriptDir&"\CodeFont.txt", $a_Image, 0, 4, 8, "7403", 6, 5, 4, 4)
$a_Image = myReadImageToArray(@ScriptDir&"\code\17.jpg", True, 1, 0x777777)
myArrarOCR(@ScriptDir&"\CodeFont.txt", $a_Image, 0, 4, 8, "9850", 6, 5, 4, 4)
