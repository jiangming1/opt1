...
$CodeWidth=5 ;验证码宽度为5个点
$func_left=5 ;左边有5个点为空
$func_mid=1 ;中间有1个点为空
$func_top=1 ;上方有1行为空
$func_bottom=0 ;下方有0行为空

$s_FontFile = @ScriptDir&"\CodeFont.txt"
FileDelete($s_FontFile)

$a_Image = myReadImageToArray(@ScriptDir&"\code\3.gif", True, 1, 0x777777);学习6913, 还缺245780没学过
myArrarOCR($s_FontFile, $a_Image, 0, $CodeNum, $CodeWidth, "6913", $func_left, $func_mid, $func_top, $func_bottom)

$a_Image = myReadImageToArray(@ScriptDir&"\code\10.gif", True, 1, 0x777777);学习8243, 还缺570没学过
myArrarOCR($s_FontFile, $a_Image, 0, $CodeNum, $CodeWidth, "8243", $func_left, $func_mid, $func_top, $func_bottom)

$a_Image = myReadImageToArray(@ScriptDir&"\code\17.gif", True, 1, 0x777777);学习5979,还缺0没学过
myArrarOCR($s_FontFile, $a_Image, 0, $CodeNum, $CodeWidth, "5979", $func_left, $func_mid, $func_top, $func_bottom)

$a_Image = myReadImageToArray(@ScriptDir&"\code\15.gif", True, 1, 0x777777);学习0929,0-9都学完了
myArrarOCR($s_FontFile, $a_Image, 0, $CodeNum, $CodeWidth, "0929", $func_left, $func_mid, $func_top, $func_bottom)
