...
$a_Image = myReadImageToArray(@ScriptDir&"\code\14.gif", True, 1, 0x777777);5648
$s_code_string = myArrarOCR(@ScriptDir&"\CodeFont.txt", $a_Image, 1, $CodeNum, $CodeWidth, "", $func_left, $func_mid, $func_top, $func_bottom)
MsgBox(0, "识别结果", $s_code_string);5648

$a_Image = myReadImageToArray(@ScriptDir&"\code\23.gif", True, 1, 0x777777);4103
$s_code_string = myArrarOCR(@ScriptDir&"\CodeFont.txt", $a_Image, 1, $CodeNum, $CodeWidth, "", $func_left, $func_mid, $func_top, $func_bottom)
MsgBox(0, "识别结果", $s_code_string);4103
