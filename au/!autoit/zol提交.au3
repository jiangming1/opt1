...
$oIE.document.parentWindow.softinform.softname.value=IniRead(@ScriptDir &"\百度提交软件.ini", "Genera"&$i, "softName", "")
...
$oIE.document.parentWindow.softinform.dwCompany.value="管家婆"
...
$oIE.document.parentWindow.softinform.downurl1.value=IniRead(@ScriptDir & "\百度提交软件.ini","Genera"&$i, 'down_url', '')
$oIE.document.parentWindow.softinform.image.value="http://www.gjprj.cn/down/"&IniRead(@ScriptDir & "\百度提交软件.ini","Genera"&$i, 'snap_1', '')&"1.png"
$oIE.document.parentWindow.softinform.tags.value="管家婆,管家婆软件,仓库管理软件"
;img_file_1
;xhe0_iframe
;_IEQuit($oie)
Next
