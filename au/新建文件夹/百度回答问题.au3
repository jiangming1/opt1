...
$asks=readask()
;<iframe width="100%" height="100%" frameborder="0" scroll="no" id="ueditor_0"></iframe>
;class= <input type="text" maxlength="4" class="ik-authcode-input">
;<a href="#" class="btn-32-green grid-r" alog-action="qb-ans-sb">提交回答</a>
	for $i=1 to $asks[0]
		$u=$zhanghao[$i]
...
func readzhanghao()
	_IENavigate($oie,"http://www.caiwuhao.com/d/百度发问题.au3.txt")
	_IELoadWait($oie)
$keyword=StringSplit($oie.document.html.outertext, chr(13),1)
MsgBox(0,0,$oie.document.body.outertext)
return $keyword
EndFunc
func logout()
